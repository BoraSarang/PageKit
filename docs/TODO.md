...
| T | 작업 | 상태 | 비고 |
|---|------|------|------|
| T-120 | 스트림 캐치 실측 개선: analyze settle 루프(최대 3초 재수집) | ✅ | extractor.js |
| T-121 | 다운로드 명시적 시작 + 해상도/예상 용량(<select>·단일해상도·약 N MB) | ✅ | downloader.js |
| T-122 | 스트림 용량 상한 옵션화 (무제한/100/200/300, 기본 무제한) | ✅ | storage.js |streamMaxMB |
| T-123 | 유튜브 진단 카드: 다운로드 불가 + 형식 셀렉트 + URL 복사(페이지 주소) | ✅ | sidepanel/panel.js |
...
| T-112 | v1.0.0 리팩토링 마일스톤(prettier·중복 제거·핸들러 분리·E2E) + 회귀 수습 6건 | ✅ | 커밋 342048e~338f848 |
